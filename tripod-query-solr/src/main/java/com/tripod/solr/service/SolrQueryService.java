...
import com.tripod.solr.SolrDocumentTransformer;
...
/**
 * Base class for all Solr QueryService implementations.
 *
 * @author bbende
 */
public class SolrQueryService<Q extends Query, QR extends QueryResult> implements QueryService<Q,QR> {
